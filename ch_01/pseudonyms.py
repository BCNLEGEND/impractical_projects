"""Program - Funny name generator, which returns a funny sidekick name"""
import sys
import random

def main():
    """Main function takes a first and last name and combines it to returns a funny name."""
    ...
    while True:
        ...
        print('\n')
        print(f'{f_name} {l_name}', file = sys.stderr)
        print('\n')
